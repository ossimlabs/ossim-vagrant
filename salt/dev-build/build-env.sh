...
export LD_LIBRARY_PATH=$OSSIM_DEPENDENCIES/lib64:$OSSIM_DEPENDENCIES/lib:$OSSIM_BUILD_DIR/lib64:$OSSIM_BUILD_DIR/lib:$OSSIM_INSTALL_PREFIX/lib64:$OSSIM_INSTALL_PREFIX/lib:$LD_LIBRARY_PATH
